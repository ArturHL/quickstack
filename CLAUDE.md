...
- **1.3**: Pedidos + Pagos (3 sem) — Sistema completo de órdenes | ⏳ EN PROGRESO (3/6 sprints) | Sprint 1: Branch/Area/Table ✅ | Sprint 2: Customer ✅ | Sprint 3: Order Core ✅ | Módulos: `quickstack-branch` + `quickstack-pos`
- **1.4**: Frontend POS (3 sem) — UI completa del punto de venta | 15 pantallas | ~120 tests

**Próximo sprint**: Phase 1.3 Sprint 4 — Order Management (crear/modificar/enviar orden + OrderController)
