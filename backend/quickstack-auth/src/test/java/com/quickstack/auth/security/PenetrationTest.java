...
class PenetrationTest {
        ...
        @BeforeEach
        void setUp() {
                com.quickstack.common.config.properties.JwtProperties jwtProperties = new com.quickstack.common.config.properties.JwtProperties();
                ...
                com.quickstack.common.config.properties.CookieProperties cookieProperties = new com.quickstack.common.config.properties.CookieProperties();
                com.quickstack.common.config.properties.CookieProperties.RefreshTokenCookie rtCookie = new com.quickstack.common.config.properties.CookieProperties.RefreshTokenCookie();
        ...
        class SqlInjectionTests {
                ...
                void sqlInjectionInEmailPassedAsLiteralToRepository() {
                        ...
                        // Repository returns empty (injection doesn't work - JPA uses parameterized
                        // queries)
                ...
                void sqlInjectionInPasswordFieldDoesNotReachDatabase() {
                        ...
                        LoginRequest request = new LoginRequest(TENANT_ID.toString(), maliciousEmail,
                                        maliciousPassword);
                        MockHttpServletRequest httpRequest = createMockRequest();
                        MockHttpServletResponse httpResponse = new MockHttpServletResponse();
                ...
                void refreshTokenReuseIsDetectedAndFamilyRevoked() {
                        ...
                        when(refreshTokenService.rotateToken(eq(revokedToken), anyString(), anyString()))
                                        .thenThrow(InvalidTokenException
                                                        .revoked(InvalidTokenException.TokenType.REFRESH_TOKEN));
        ...
        class TimingAttackTests {
                ...
                void forgotPasswordAlwaysReturns200() {
                        ...
                        com.quickstack.auth.dto.request.ForgotPasswordRequest requestNoUser = new com.quickstack.auth.dto.request.ForgotPasswordRequest(
                        ...
                        com.quickstack.auth.dto.request.ForgotPasswordRequest requestWithUser = new com.quickstack.auth.dto.request.ForgotPasswordRequest(
                                        TENANT_ID.toString(), "existing@example.com");

                        when(passwordResetService.initiateReset(anyString(), eq(TENANT_ID), anyString()))
                                        .thenReturn(PasswordResetService.ResetInitiationResult.success("token", USER_ID,
