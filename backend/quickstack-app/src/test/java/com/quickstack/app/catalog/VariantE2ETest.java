...
class VariantE2ETest extends BaseE2ETest {
    ...
    void addVariantSuccess() {
        VariantCreateRequest request = new VariantCreateRequest("Familiar", "PIZ-PEP-FM", new BigDecimal("100.00"),
                false, 3);
    ...
    void addVariantForbiddenCashier() {
        VariantCreateRequest request = new VariantCreateRequest("Extra Grande", "PIZ-PEP-XG", new BigDecimal("150.00"),
                false, 4);
    ...
    void updateVariantSuccess() {
        ...
        VariantUpdateRequest request = new VariantUpdateRequest("Super Chica", null, new BigDecimal("-2.00"), null,
                null, null);
    ...
    void deleteVariantSuccess() {
        // Need at least 2 variants so we don't hit the "cannot delete last variant"
        // rule.
        createVariantDirect(tenantId, productId, "Chica", "PIZ-PEP-CH", BigDecimal.ZERO, true, 1);
        UUID variantToDelete = createVariantDirect(tenantId, productId, "Mediana", "PIZ-PEP-MD",
                new BigDecimal("50.00"), false, 2);
    ...
    private UUID createVariantDirect(UUID forTenantId, UUID prodId, String name, String sku, BigDecimal priceAdj,
