...
import com.quickstack.user.controller.AuthController;
...
import com.quickstack.user.service.*;
...
class PenetrationTest {
    ...
    @Mock
    private com.quickstack.user.repository.RefreshTokenRepository refreshTokenRepository;
    ...
    class IdorTests {
        ...
        void userCannotRevokeAnotherUsersSession() {
            ...
            com.quickstack.user.entity.RefreshToken victimToken = RefreshToken.create(
    ...
    class TimingAttackTests {
        ...
        void forgotPasswordAlwaysReturns200() {
            ...
            com.quickstack.user.dto.request.ForgotPasswordRequest requestNoUser =
                    new com.quickstack.user.dto.request.ForgotPasswordRequest(
            ...
            com.quickstack.user.dto.request.ForgotPasswordRequest requestWithUser =
                    new com.quickstack.user.dto.request.ForgotPasswordRequest(
