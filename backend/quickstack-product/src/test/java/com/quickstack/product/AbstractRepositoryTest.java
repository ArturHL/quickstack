...
/**
 * Shared base for all @DataJpaTest classes in quickstack-product.
 * <p>
 * Starts a single PostgreSQL container once (static initializer) and provides
 * it to all subclasses via @DynamicPropertySource. Reduces container startups
 * from 6 (one per repository test class) to 1 per JVM run.
 * <p>
