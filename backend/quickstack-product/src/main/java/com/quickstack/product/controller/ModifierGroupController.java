 ...
 * <p>
 * Endpoints:
 * - GET    /api/v1/products/{productId}/modifier-groups          - List modifier groups for a product
 * - POST   /api/v1/products/{productId}/modifier-groups          - Create modifier group (OWNER/MANAGER)
 * - GET    /api/v1/modifier-groups/{id}                          - Get modifier group by ID
 * - PUT    /api/v1/modifier-groups/{id}                          - Update modifier group (OWNER/MANAGER)
 * - DELETE /api/v1/modifier-groups/{id}                          - Soft delete modifier group (OWNER/MANAGER)
 * - GET    /api/v1/modifier-groups/{groupId}/modifiers           - List modifiers in a group
 * - POST   /api/v1/modifier-groups/{groupId}/modifiers           - Add modifier (OWNER/MANAGER)
...
public class ModifierGroupController {
    ...
    /**
     * Soft-deletes a modifier group and cascades to its modifiers. Requires OWNER or MANAGER role.
     */
    ...
    public ResponseEntity<Void> deleteModifierGroup(
        ...
        log.info("Deleting modifier group id={}, tenant={}, by={}", id, principal.tenantId(), principal.userId());
