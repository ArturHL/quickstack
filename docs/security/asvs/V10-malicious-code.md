...
| 10.3.3 | Verificar que la aplicacion tenga proteccion contra toma de control de subdominios si la aplicacion depende de entradas DNS o subdominios DNS, como nombres CNAME expirados, punteros DNS obsoletos o CNAMEs, o proyectos expirados en repositorios de codigo fuente publico | L1 | ⏳ | **Pendiente Phase 6:** Monitoreo de DNS. Sin subdominios dangling. AWS Route 53 maneja DNS correctamente. Verificacion periodica de config DNS. |
